...
public class DispatcherTest {
    ...
    public void testDispatch() {
        ...
        modelAndView.setView(View.LOGIN);

        Dispatcher dispatcher = Dispatcher.getInstance();

        Map<String, String[]> parametersMap = new HashMap<>();
        HttpServletRequest httpServletRequest1 = new HttpServletRequest() {
            @Override
        ...
        //when
        Dispatcher actual = dispatcher.getInstance();
        ModelAndView dispatch = actual.dispatch("/user/signUp", "POST", parametersMap, httpServletRequest1);

        //then
        Assert.assertEquals(modelAndView, dispatch);
